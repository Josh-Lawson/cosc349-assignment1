...
Vagrant.configure("2") do |config|
    ...
    config.vm.define "userinterface" do |userinterface|
        ...
        userinterface.vm.synced_folder ".", "/vagrant", owner: "vagrant", group: "vagrant", mount_options: ["dmode=775,fmode=777"]
    ...
    config.vm.define "admininterface" do |admininterface|
        ...
        admininterface.vm.synced_folder ".", "/vagrant", owner: "vagrant", group: "vagrant", mount_options: ["dmode=775,fmode=777"]
