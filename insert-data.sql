...
-- Recipe 2
INSERT INTO Recipe (userId, recipeName, instructions, description, approved)
VALUES (1, 'Spaghetti Carbonara', 'Cook pasta according to package instructions. In a large pan, cook bacon until crispy. Remove bacon from pan and set aside. In the same pan, cook garlic until fragrant. In a separate bowl, whisk together eggs and cheese. Drain pasta and return to pot. Add the egg mixture, bacon, and garlic to the pasta and toss to combine. Season with salt and pepper to taste.', 'An Italian dish of spaghetti tossed with a sauce made from eggs, cheese, bacon, garlic, salt, and pepper.', 1);
...
-- Recipe 5
INSERT INTO Recipe (userId, recipeName, instructions, description, approved)
VALUES (1, 'Classic Beef Stew', 'In a large pot, heat oil over medium heat. Add beef and cook until browned on all sides. Remove beef from pot and set aside. In the same pot, add onion and cook until tender. Add garlic and cook until fragrant. Return beef to pot and add broth, potatoes, carrots, and peas. Bring to a boil, then reduce heat and simmer for 1-2 hours or until beef is tender.', 'A hearty dish of beef browned and simmered with onions, garlic, broth, potatoes, carrots, and peas until tender.', 1);
