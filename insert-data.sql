...
-- insert 2 admins for testing:

insert into Admin (username, password) values ('admin1', 'password1');
insert into Admin (username, password) values ('admin2', 'password2');

insert into User (name, username, password) values ('User', 'user123', 'password123');


-- Chat GPT was used to generate the below insert statements given a prompt detailing the database structure.

-- Recipe 1
INSERT INTO Recipe (userId, recipeName, instructions, approved)
VALUES (1, 'Chocolate Chip Cookies', 'Preheat oven to 350 degrees F. In a large bowl, mix together the flour, baking powder, and salt. In a separate bowl, cream together the butter and sugars. Add the eggs and vanilla extract and mix well. Gradually add the dry ingredients to the wet ingredients, mixing until just combined. Stir in the chocolate chips. Drop spoonfuls of dough onto a greased baking sheet. Bake for 10-12 minutes or until the edges are lightly golden.', 1);
...
-- Recipe 5
INSERT INTO Recipe (userId, recipeName, instructions, approved)
VALUES (1, 'Classic Beef Stew', 'In a large pot, heat oil over medium heat. Add beef and cook until browned on all sides. Remove beef from pot and set aside. In the same pot, add onion and cook until tender. Add garlic and cook until fragrant. Return beef to pot and add broth, potatoes, carrots, and peas. Bring to a boil, then reduce heat and simmer for 1-2 hours or until beef is tender.', 1);
